...
`ut02/hoja.html` es la hoja en papel de la UT2: cronogramas de cada algoritmo (con el solucionario coloreado) y los demás ejercicios de la unidad, con la misma semilla por número de lista.
